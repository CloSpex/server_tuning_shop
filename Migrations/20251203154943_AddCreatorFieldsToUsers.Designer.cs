...
namespace server.Migrations
{
    ...
    [Migration("20251203154943_AddCreatorFieldsToUsers")]
    partial class AddCreatorFieldsToUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TuningStore.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TuningStore.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TuningStore.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TuningStore.Models.OrderItem", b =>
                {
                    b.HasOne("TuningStore.Models.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TuningStore.Models.Part", "Part")
                        .WithMany()
            ...
            modelBuilder.Entity("TuningStore.Models.RefreshToken", b =>
                {
                    b.HasOne("TuningStore.Models.User", "User")
